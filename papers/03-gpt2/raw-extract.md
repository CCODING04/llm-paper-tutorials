...
$$
p (x) = \prod_ {i = 1} ^ {n} p (s _ {n} | s _ {1},..., s _ {n - 1}) \tag {1}
$$
...
| # of parameters in LM | Human Accuracy | Bajgar et al. (2016) Accuracy |
| --------------------- | -------------- | ---------------------------- |
| 117M                  | 95             | 83                           |
| 345M                  | 95             | 87                           |
| 762M                  | 95             | 88                           |
