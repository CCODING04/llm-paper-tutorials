...
| # | 论文 | 年份 | 核心主题 | 面试重要度 | 状态 |
|---|------|------|---------|-----------|------|
| 02 | [BERT](./papers/02-bert/) | 2018 | 双向预训练编码器 | ⭐⭐⭐⭐⭐ | 📋 待开始 |
...
| A3 | [Qwen2 Technical Report](./papers/A3-qwen2/) | 2024 | 数据配方 + 长上下文 | ⭐⭐⭐⭐ | 📋 待开始 |
| A4 | [MiniMax-01](./papers/A4-minimax01/) | 2025 | 线性注意力混合架构 | ⭐⭐⭐⭐ | 📋 待开始 |
...
### A3 - Qwen2
- **重点理解**：数据配方的工程实践、长上下文扩展技术
- **面试常问**：RoPE 缩放、Dual Chunk Attention

### A4 - MiniMax-01
- **重点理解**：线性注意力 + Softmax 注意力的混合架构
- **面试常问**：线性注意力的优劣、为什么混合而非纯线性
- **注意**：400万+ 超长上下文的技术方案
